...
Ex: require_once ROOT . DS . 'vendor' . DS . 'autoload.php'; // To do: Replace ROOT directory of your project to load
...
Ex: require_once APP . 'Lib' . DS . 'Aws' . DS . 'Sns' . DS . 'autoload.php';
